        ...
        <nav class="navbar navbar-expand-lg bg-danger">
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link {{ (request()->segment('1')=="" || request()->segment('1') == 'home')? 'active' : '' }}" aria-current="page" 
                     href="{{ url('home') }}">
                    <i class="fas fa-tachometer-alt"></i> Home
                  </a>
    
                  <a class="nav-link {{ (request()->segment('1')=="" || request()->segment('1') == 'students')? 'active' : '' }} " aria-current="page"
                     href="{{ url('students') }}">
                     <i class="fas fa-user-graduate"></i> Students
                  </a>
    
                  <a class="nav-link {{ (request()->segment('1')=="" || request()->segment('1') == 'profile')? 'active' : '' }} " aria-current="page"
                    href="{{ url('profile') }}">
